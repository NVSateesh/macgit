...
//		
//		if (source.contains(rstname)){  //if (source.contains("No products available for this restaurant."))
//			
//     	Thread.sleep(1000);
//     	
...
//		}
//		
//		System.out.println("Verified all the restaurants in "+areaValue+" area. Also exported the data to excel file, please refer to the same.");
//		
//		driver.close();
//	}
//
